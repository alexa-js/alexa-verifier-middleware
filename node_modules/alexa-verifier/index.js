...
function getCert (cert_url, overrideTECheck, callback) {
  ...
  fs.stat(cert_filepath, function(er, stat) {
    ...
    fetchCert(cert_uri, function(er, pem_cert) {
      ...
      validateCert(pem_cert, overrideTECheck, function(er) {
        if (er) {
          return callback(er);
        }
...
function validateCert(pem_cert, overrideTECheck, callback) {
...
module.exports = function(cert_url, signature, requestBody, overrideTECheck, callback) {
  var er;
  if (cert_url == null) {
    cert_url = '';
  }
  ...
  getCert(cert_url, overrideTECheck, function(er, pem_cert) {
    var success;
    if (er) {
      return callback(er);
    }
